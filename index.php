        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="profiles/profiles.php?id=<?= $_SESSION['usuario']['id'] ?>">
                        ...
                        <form form action="tweet.php" method="POST">
                            <div class="mb-3">
    ...
    <div class="container-sm">
        ...
        <form action="registro.php" method="POST" class="row g-3">
            <div class="col-md-6">
                ...
                <?php
                if (isset($_SESSION['errores']) && isset($_SESSION['errores']['username'])) {
                    echo $_SESSION['errores']['username'];
                    $_SESSION['errores']['username'] = "";
                }
                ?>
            </div>
            <div class="col-md-6">
